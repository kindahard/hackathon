# 🛠️ Hackathon Readiness Checklist

**Target Date:** Sunday, Jan 25, 2026 | **Role:** Data Analyst
...
> `pip install numpy pandas matplotlib seaborn plotly requests selenium`

### 2. Database Setup 🗄️

* [ ] **Microsoft SQL Server:** Installed and service running.
* [ ] **SSMS:** Have *SQL Server Management Studio* installed for easy querying.
* [ ] **Test Connection:** Verify you can create a dummy database and run a `SELECT` query.
...
* [ ] **Tableau:** Installed (Public or Desktop version depending on your license).
...
Since you are dealing with **Selenium** and **SQL**, create a folder on your desktop named `Hackathon_Workspace` now. Inside it, create:

1. `data/` (for your CSVs/Excel files)
2. `notebooks/` (for Python scripts)
3. `queries/` (for saving SQL scripts)
4. `drivers/` (place your Selenium WebDrivers here so you don't lose them)

**Good luck with the filtration! You are going to crush it.** 💙
